...
create new Scanner for the user input
create the code for int days to see how many days user wants
create do while loop
    ask the user for the number of days and put it into int variable
